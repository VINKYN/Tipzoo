...
def create_connection(db_file):
    ...
    try:
        ...
        Param_Tapho INTEGER CHECK(Param_Tapho IN(0,1,2,3,4,5)),
        Param_Path Text 
        );
        ...
        Base_ID VARCHAR(25),
        Base_CheckCode VARCHAR(7) CHECK(Base_CheckCode IN('PROBLEM')),
        ...
        Species_CheckImprove VARCHAR(15) CHECK(Species_CheckImprove IN('To Improve' , 'To Check')),
        ...
        Skel_AgeFus VARCHAR(7) CHECK(Skel_AgeFus IN ('fus','justfus','unfus')),
        ...
        Teeth_Portion VARCHAR(4) CHECK(Teeth_Portion IN('CRN','ROOT')),
    ...
    cursor.close()
bang = "tipzoo"
path = "C:/Users/vince/OneDrive/Bureau/Tipzoo-DEV/Database/"+bang+".sqlite3"
